...
#testing
from mode import v_r_test,sudutRobot_test
#==========
from mapping import map,valnya, grid,grid_scale,delta,movementRobot,printmap,cartesianRobot,map_posisi
...
putar_gagal_2 = True
update_sudut = False
nama_file = str("data "+str(v)+", "+str(v_k)+".csv")
...
def cek_arah_robot():
    ...
    if timer_putar == 400:
        leftMotor.setVelocity(0)
        rightMotor.setVelocity(0)
        print("gagal ",v_r,v_r_test[kecepatan],sudutRobot_test[putaran])
        sys.exit(0)
...
#ambil data
write3 = ["name","error","koreksi","x","y","dP_map","dP","P","theta"]
